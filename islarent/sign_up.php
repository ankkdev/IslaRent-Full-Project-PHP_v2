...
<body class="flex flex-col min-h-screen font-sans m-0">
    ...
    <main class="flex-1 flex-col items-center justify-center p-4 bg-white h-screen flex">
        <h1 class="text-3xl font-semibold text-gray-900 mb-6">Registrarse</h1>
        <form action="register.php" autocomplete="off" method="POST" class="border border-blue-500 rounded-lg p-10 self-center">
            <div class="mb-4">
            ...
            <div class="mb-4">
                <input type="text" placeholder="Nombre" name="nombre" required class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="mb-4">
                <input type="tel" placeholder="Numero telefono" name="telf" required class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">

            </div>
            <div class="mb-4">
                <input type="password" name="pswd" autocomplete="new-password" placeholder="Nueva Contraseña" required class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="mb-4">
                <input type="password" name="s_pswd" autocomplete="new-password" placeholder="Repite contraseña" required class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <input type="submit" required value="Registrarse" class="bg-blue-500  w-full text-white p-3 rounded-md hover:bg-blue-700 focus:ring-green-500">
            <a href="sign_in.php" class="text-blue-500 hover:text-blue-950">Ya tienes cuenta? Inicia sesión</a>
        </form>
    </main>

(() => {
  ...
  function Be(e, t, r) {
    if ((typeof t == "string" && (t = t.split(".")), t.length === 1))
      ...
      return e[t[0]] || (e[t[0]] = {}), Be(e[t[0]], t.slice(1), r);
    }
  }
  var Ct = {};
  function x(e, t) {
    ...
    return (
      Object.entries(Ct).forEach(([r, n]) => {
        Object.defineProperty(e, `$${r}`, {
          get() {
            return n(t, { Alpine: E, interceptor: fe });
          },
          enumerable: !1,
        });
      }),
...
`,
  ...
  function k(e, t) {
    ...
    for (; n; ) k(n, t, !1), (n = n.nextElementSibling);
  }
  function _e(e, ...t) {
  ...
  function $t() {
    ...
    Array.from(document.querySelectorAll(qr()))
      .filter(e)
      .forEach((t) => {
        A(t);
      }),
  ...
  function N(e) {
    if (Kt().some((t) => e.matches(t))) return e;
    if (!!e.parentElement) return N(e.parentElement);
  }
  function Vt(e) {
  ...
  var Zi = {
    ...
    Xi = { [1]: "STABLE", [2]: "DYNAMIC", [3]: "FORWARDED" };
  var Jr =
  ...
  var Xr = Object.prototype.toString,
    ...
    nt = (e) => Zt(e).slice(8, -1);
  var be = (e) =>
    Zr(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e;
  var ve = (e) => {
  ...
  function nn(e, t) {
    let r = function () {
      ...
      if (!re.includes(r)) {
        er(r);
        try {
          return sn(), re.push(r), (O = r), e();
        } finally {
          re.pop(), rr(), (O = re[re.length - 1]);
        }
      }
    };
    return (
  ...
  ["includes", "indexOf", "lastIndexOf"].forEach((e) => {
    ...
    Ee[e] = function (...r) {
      let n = g(this);
      for (let o = 0, s = this.length; o < s; o++) v(n, "get", o + "");
      let i = t.apply(n, r);
  ...
  function we(e = !1, t = !1) {
    return function (n, i, o) {
      ...
      if (i === "__v_raw" && o === (e ? (t ? mn : or) : t ? pn : ir).get(n))
        return n;
      let s = D(n);
      if (!e && s && ee(Ee, i)) return Reflect.get(Ee, i, o);
      let a = Reflect.get(n, i, o);
      return (xe(i) ? nr.has(i) : cn(i)) || (e || v(n, "get", i), t)
        ? a
        : lt(a)
        ? !s || !be(i)
          ? a.value
  ...
  function yn(e, t) {
    ...
    return (!xe(t) || !nr.has(t)) && v(e, "has", t), r;
  }
  function xn(e) {
    return v(e, "iterate", D(e) ? "length" : $), Reflect.ownKeys(e);
  }
  var cr = { get: ln, set: hn, deleteProperty: _n, has: yn, ownKeys: xn },
    lr = {
      get: fn,
      set(e, t) {
        return (
  ...
  function Re(e, t = !1) {
    return (
      (e = e.__v_raw), !t && v(g(e), "iterate", $), Reflect.get(e, "size", e)
    );
  }
  function ur(e) {
    e = g(e);
  ...
  function Ce(e, t) {
    return function (n, i) {
      let o = this,
        ...
        c = t ? dt : e ? ft : ut;
      return (
        !e && v(a, "iterate", $), s.forEach((l, u) => n.call(i, c(l), c(u), o))
      );
    };
  }
  function Ne(e, t, r) {
    return function (...n) {
      ...
      return (
        ...
        {
          next() {
            let { value: d, done: w } = l.next();
            return w
              ? { value: d, done: w }
              : { value: a ? [u(d[0]), u(d[1])] : u(d), done: w };
          },
          [Symbol.iterator]() {
            return this;
          },
  ...
  function Sn(e) {
    return e.__v_skip || !Object.isExtensible(e) ? 0 : En(nt(e));
  }
  function Se(e) {
    return e && e.__v_isReadonly ? e : xr(e, !1, cr, vn, ir);
  }
  function sr(e) {
    return xr(e, !0, lr, wn, or);
  }
  ...
  function ie(e, t) {
    return typeof t == "object" && t !== null ? On(e, t) : Tn(e, t);
  }
  function On(e, t) {
    let r = {};
    return (
  ...
  p(
    ...
    (e, { value: t, modifiers: r, expression: n }, { evaluate: i }) => {
      typeof n == "function" && (n = i(n)), n ? Rn(e, n, t) : Cn(e, r, t);
    }
  );
  function Rn(e, t, r) {
    vr(e, ne, ""),
  ...
  var Sr = () => {};
  Sr.inline = (e, { modifiers: t }, { cleanup: r }) => {
  ...
  p("cloak", (e) =>
    queueMicrotask(() => m(() => e.removeAttribute(S("cloak"))))
  );
  zt(() => `[${S("init")}]`);
  p(
    "init",
    U((e, { expression: t }) => C(e, t, {}, !1))
  );
    ...
    r((s) => {
      ...
      if (i(s))
        s = Object.entries(s).map(([f, _]) => {
          let y = Tr(t, _, f, s);
          n((T) => u.push(T), { scope: { index: f, ...y } }), l.push(y);
        });
      else
      ...
      for (let f = 0; f < u.length; f++) {
        let _ = u[f],
          y = c.indexOf(_);
        if (y === -1) c.splice(f, 0, _), d.push([le, f]);
        else if (y !== f) {
          let T = c.splice(f, 1)[0],
            M = c.splice(y - 1, 1)[0];
          c.splice(f, 0, M), c.splice(y, 0, T), w.push([T, M]);
        } else j.push(_);
        le = _;
      }
      ...
      for (let f = 0; f < w.length; f++) {
        ...
        m(() => {
          M.after(K), T.after(M), K.before(T), K.remove();
        }),
          Ve(M, l[u.indexOf(y)]);
      }
